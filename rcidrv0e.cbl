...
* --------------------
*
* Testdriver fuer SSF-Modul SSFRCI0 (sichern/wiederherstellen 
* Indextabelle SSFRARCH
*
******************************************************************
...
*--------------------------------------------------------------------*
 01          KONSTANTE-FELDER.
     05      K-MODUL             PIC X(08)          VALUE "RCIDRV0E".
...
******************************************************************
* Select auf Tabelle SSFRARCH
******************************************************************
 S100-COUNT-SSFRARCH SECTION.
 S100-00.

**  ---> Bei Recover irrelevant, da neu gebaut werden soll
     IF STUP-MOD-CMD = "RI"
        EXIT SECTION
     END-IF
     ...
     EVALUATE SQLCODE OF SQLCA
         ...
         WHEN OTHER      MOVE SQLCODE OF SQLCA TO D-NUM4
                         DISPLAY " COUNT SSFRARCH SQLCODE: " D-NUM4
                         DISPLAY " Verarbeitung nicht moeglich"
                         SET PRG-ABBRUCH TO TRUE
                         EXIT SECTION
     ...
     IF H-ARCH-COUNT > ZERO
        EXIT SECTION
     END-IF
     
     DISPLAY SOURCE-MODUL OF SSFRARCH,
             " nicht im (neuen) SOURCE-SAFE"
     DISPLAY " >>> Nichts zu tun <<<"
     SET PRG-ABBRUCH TO TRUE
     .
 S100-99.
     EXIT.
