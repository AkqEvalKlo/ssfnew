...
*****************************************************************
* Letzte Aenderung :: 2018-04-11
* Letzte Version   :: G.00.00
* Kurzbeschreibung :: Testdriver fuer SSF-Modul SSFFLK0
*
...
*--------------------------------------------------------------------*
 01          KONSTANTE-FELDER.
     05      K-MODUL             PIC X(08)          VALUE "FLKDRV0O".
...
**  --> Aufrufen SSFCOU0
     CALL "SSFFLK0M"     USING LINK-REC
     EVALUATE LINK-RC
     
        WHEN   ZERO   CONTINUE
        
        WHEN   9999   DISPLAY " RC 9999 = PRG-ABBRUCH aus SSFFLK0 "
