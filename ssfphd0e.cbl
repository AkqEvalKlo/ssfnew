...
*       |          |     |
*-------|----------|-----|---------------------------------------*
*G.00.00|2018-02-25| kl  | Neuerstellung
*       |2018-03-06| kl  | Umbenannt SYSINV0 > SSFPHD0
*----------------------------------------------------------------*
*
...
*--------------------------------------------------------------------*
 01          KONSTANTE-FELDER.
     05      K-MODUL             PIC X(08)          VALUE "SSFPHD0S".
...
******************************************************************
 ...
 R000-00.
     ...
     ELSE
         IF RD-IIFC
*           Interne Schnittstelle gelesen
            MOVE IMSG-SENDLEN TO IMSG-DATLEN
*           Sichern fuer Rueckgabe
            MOVE INTERN-MESSAGE TO SV-INTERN-MESSAGE
         ELSE
*           Rueckgabe $RECIEVE aus CREATEPROCESS gelesen
*           Jetzt wieder INTERN-MESSAGE lesen
            MOVE   INTERN-MESSAGE(1:200)    TO MSG-SATZ
            MOVE   SV-INTERN-MESSAGE        TO INTERN-MESSAGE
            MOVE   200                      TO IMSG-DATLEN
